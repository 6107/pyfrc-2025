# First Robotics Challenge 2025 - Team 6107    CyberJagzz

The code in this directory is based on the Java based competition code
for the CyberJagzz team. 2026 will be python based and by rewriting the
